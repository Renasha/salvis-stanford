...
export default function MathReqs() {
    return (
                                ...
                                <tbody>
                                    <tr className="bg-white border-t transition duration-300 ease-in-out hover:bg-gray-100">
                                        ...
                                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            <span className={stoplightColor("Taken") + "inline-block rounded-full  px-2 py-1 text-xs"}>{"Taken"}</span>
                                        </td>
                                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            5
                                        </td>
                                    ...
                                    <tr className="bg-white border-t transition duration-300 ease-in-out hover:bg-gray-100">
                                        ...
                                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            <span className={stoplightColor("Enrolled") + "inline-block rounded-full  px-2 py-1 text-xs"}>{"Planned"}</span>
                                        </td>
                                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            5
                                        </td>
